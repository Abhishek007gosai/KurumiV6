...
async def settings_command(client: Client, message: Message):
    try:
        keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("Lɪɴᴋ sʜᴀʀᴇ ᴍᴇɴᴜ", callback_data="link_share"), InlineKeyboardButton("Bᴀɴ ᴍᴇɴᴜ", callback_data="ban_menu")],
            [InlineKeyboardButton("Sʜᴏʀᴛᴇɴᴇʀ", callback_data="shortener_menu"), InlineKeyboardButton("Cᴀᴘᴛɪᴏɴ", callback_data="caption_menu")],
...
async def settings_callback(client: Bot, callback_query):
    ...
    try:
        ...
        if cb_data == "settings_main":
            ...
            btn = [
                [InlineKeyboardButton("Aᴅᴅ ᴄʜᴀɴɴᴇʟ", callback_data="add_channel"), InlineKeyboardButton("Dᴇʟᴇᴛᴇ ᴄʜᴀɴɴᴇʟ", callback_data="delete_channel")],
                [InlineKeyboardButton("Nᴏʀᴍᴀʟ ʟɪɴᴋs", callback_data="channel_links"), InlineKeyboardButton("Rᴇǫᴜᴇsᴛ ʟɪɴᴋs", callback_data="request_links")],
                [InlineKeyboardButton("Lɪsᴛ ᴄʜᴀɴɴᴇʟs", callback_data="list_channels")],
        ...
        # Ban Menu
            ...
            btn = [
                [InlineKeyboardButton("Bᴀɴ ᴜsᴇʀ", callback_data="ban_user"), 
                 InlineKeyboardButton("Uɴʙᴀɴ ᴜsᴇʀ", callback_data="unban_user")],
                [InlineKeyboardButton("Bᴀɴɴᴇᴅ ʟɪsᴛ", callback_data="banned_list")],
                [InlineKeyboardButton("Bᴀᴄᴋ", callback_data="settings_main")]
            ]
        ...
        # Ban User
            ...
            btn = [[InlineKeyboardButton("Bᴀᴄᴋ", callback_data="ban_menu")]]
            await callback_query.message.edit_text(
        ...
        # Fsub Settings Menu
            ...
            btn = [
                [InlineKeyboardButton("Aᴅᴅ ᴄʜᴀɴɴᴇʟ", callback_data="add_fsub_channel"), InlineKeyboardButton("Rᴇᴍᴏᴠᴇ ᴄʜᴀɴɴᴇʟ", callback_data="delete_fsub_channel")],
                [InlineKeyboardButton("Lɪsᴛ ᴄʜᴀɴɴᴇʟs", callback_data="list_fsub_channels")],
                [InlineKeyboardButton("Tᴏᴏɢʟᴇ ʀᴇǫ ᴀ", callback_data="fsub_all_channels"), InlineKeyboardButton("Tᴏᴏɢʟᴇ ʀᴇǫ ʙ", callback_data="fsub_particular")],
                [InlineKeyboardButton("Bᴀᴄᴋ", callback_data="settings_main")]
            ]
            await callback_query.message.edit_text(
        ...
        # All Channels Toggle
            ...
            btn = [
                [InlineKeyboardButton("Eɴᴀʙʟᴇ ᴀʟʟ", callback_data="fsub_enable_all"),
                 InlineKeyboardButton("Dɪsᴀʙʟᴇ ᴀʟʟ", callback_data="fsub_disable_all")],
                [InlineKeyboardButton("Bᴀᴄᴋ", callback_data="fsub_settings_menu")]
            ]
        ...
        # Enable All Channels
            ...
            try:
                ...
                btn = [[InlineKeyboardButton("Bᴀᴄᴋ", callback_data="fsub_all_channels")]]
                await callback_query.message.edit_text(
        ...
        # Particular Fsub Channel Management
            ...
            buttons.append([InlineKeyboardButton("Bᴀᴄᴋ", callback_data="fsub_settings_menu")])
        ...
        # Handle specific channel fsub toggle
            ...
            try:
                ...
                buttons = [
                    ...
                    [InlineKeyboardButton("Bᴀᴄᴋ", callback_data="fsub_particular")]
                ]
                await callback_query.message.edit_text(
        ...
        # Add Fsub Channel
            ...
            btn = [[InlineKeyboardButton("Bᴀᴄᴋ", callback_data="fsub_settings_menu")]]
            await callback_query.message.edit_text(
        ...
        # Admin Panel
            ...
            btn = [
                [InlineKeyboardButton("Aᴅᴅ ᴀᴅᴍɪɴ", callback_data="admin_bna"), 
                 InlineKeyboardButton("Rᴇᴍᴏᴠᴇ ᴀᴅᴍɪɴ", callback_data="admin_hta")],
                [InlineKeyboardButton("Lɪsᴛ ᴀᴅᴍɪɴs", callback_data="admin_list")],
                [InlineKeyboardButton("Bᴀᴄᴋ", callback_data="settings_main")]
            ]
            await callback_query.message.edit_text(
        ...
        # List Admins - FIXED: Removed reply_markup from answer()
            ...
            try:
                ...
                btn = [[InlineKeyboardButton("Bᴀᴄᴋ", callback_data="admin_bna_system")]]
            ...
            btn = [[InlineKeyboardButton("Bᴀᴄᴋ", callback_data="settings_main")]]
            await callback_query.message.edit_text(
        ...
        await callback_query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Bᴀᴄᴋ", callback_data="settings_main")]])
        )
